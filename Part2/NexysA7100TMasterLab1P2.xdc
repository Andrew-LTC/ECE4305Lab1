...
set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports { AMT[0] }]; #IO_L24N_T3_34 Sch=sw[8]
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS18 } [get_ports { AMT[1] }]; #IO_25_34 Sch=sw[9]
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { AMT[2] }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=sw[10]
